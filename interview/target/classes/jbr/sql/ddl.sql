...
CREATE TABLE interview.users (
    ...
    latest_updated_time TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
);
...
CREATE TABLE interview.candidates(
    ...
    schname VARCHAR(50),
    schcity VARCHAR(50),
    schpassedyear VARCHAR(50),
    schmarks VARCHAR(50),
    ugname VARCHAR(50),
    ugcity VARCHAR(50),
    ugspecialization VARCHAR(50),
    ugpassedyear VARCHAR(50),
    ugmarks VARCHAR(50),
    pgname VARCHAR(50),
    pgcity VARCHAR(50),
    pgspecialization VARCHAR(50),
    pgpassedyear VARCHAR(50),
    pgmarks VARCHAR(50),
    registered_time TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    latest_updated_time TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
);
...
CREATE TABLE interview.post(
    ...
    Salary varchar(50),
    Noofposition varchar(50),
    registered_time TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    latest_updated_time TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    FOREIGN KEY(Userid) REFERENCES interview.users(Userid)
);

--
-- Table structure for table `candidateskills`
--
CREATE TABLE interview.candidateskills(
    Candidateid int,
    Skillname varchar(50),
    Proficiencylevel varchar(50),
    Registered_time TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    Latest_updated_time TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    FOREIGN KEY(Candidateid) REFERENCES interview.candidates (candidateid)
);

--
-- Table structure for table `postskills`
-- 
CREATE TABLE interview.postskills(
    ...
    registered_time TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    latest_updated_time TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    FOREIGN KEY(Positionid) REFERENCES post(Positionid),
...
-- 
CREATE TABLE interview.applications(
...
--
-- DATA DUMPING CODE BLOCKS
--
--
-- Dumping data for table `skills`
--
-- These are for sample only, to be changed as per requirement
--
INSERT INTO
    interview.skills (`Skillid`, `Skillname`)
VALUES
    (1, 'MS Word'),
    (2, 'Java'),
    (3, 'Python'),
...
--
INSERT INTO
    interview.cities (`id`, `city`, `state_id`)
VALUES
