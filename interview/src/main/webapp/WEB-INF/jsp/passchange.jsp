...
<body>
	...
	<form:form id="forgotpassword" modelAttribute="user"
		action="passchangeProcess?companyMailId=${companyemailid}"
		...
		<table align="center">
			...
			<tr>
				...
				<td align="left"><br> <form:button id="forgotpassword"
						name="forgotpassword" style="background-color:Cyan">Save</form:button></td>
			</tr>
